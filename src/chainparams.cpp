...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("3.83.99.197", "3.83.99.197", true));
        ...
        chainTxData = ChainTxData{
            ...
            1650782177, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("3.83.99.197", "3.83.99.197"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 2056, uint256S("0xb5b067441c5f4bd94ada004a2c81c4c1e0c7dba0446c96c48535f05ad17d794c")),
        };
