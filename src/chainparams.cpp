...
public:
    CTestNetParams() {
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 1, uint256S("0x5b39a6581eba1ffbd03469e76732765630f6ceedf0f62942b595c5aaa8ce0574")),
        };
...
public:
    CRegTestParams() {
        ...
        checkpointData = (CCheckpointData){
            ...
            ( 1, uint256S("0x79371dfcb3fcecf9846a6bf9ff560fb0e68d63fc35e0d9df1ff02a9c4012e0d8 "))
        };
