...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s gandercoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gandercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gandercoin transaction") + "\n" +
              "  gandercoin-tx [options] -create [commands]   " + _("Create hex-encoded gandercoin transaction") + "\n" +
              "\n";
